...
public:
	...
	// lowFreq: 41-626 Hz, highFreq: 82-1252 Hz, amplitudes: 0.0-1.0
	UFUNCTION(BlueprintCallable, Category = "JoyShockLibrary|HDRumble")
	static void JslSetHDRumble(int32 deviceId, float lowFreq, float lowAmpli, float highFreq, float highAmpli);

	// set HD Rumble for Nintendo Switch controllers (independent left/right)
	UFUNCTION(BlueprintCallable, Category = "JoyShockLibrary|HDRumble")
	static void JslSetHDRumbleLR(int32 deviceId, float lowFreq_L, float lowAmpli_L, float highFreq_L, float highAmpli_L,
